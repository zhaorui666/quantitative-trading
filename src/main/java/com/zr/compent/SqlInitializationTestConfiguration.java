...
@MapperScan(value = "com.zr.mapper", annotationClass = Mapper.class)
public class SqlInitializationTestConfiguration {
	...
	public DataSourceScriptDatabaseInitializer dataSourceScriptDatabaseInitializer(DataSource dataSource,
		...
		DatabaseInitializationSettings settings = createInitializationSettings(initializationProperties);
		return new DataSourceScriptDatabaseInitializer(dataSource, settings);
	}

	static DatabaseInitializationSettings createInitializationSettings(SqlInitializationProperties properties) {
